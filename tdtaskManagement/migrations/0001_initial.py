# Generated by Django 4.2.5 on 2023-09-10 14:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True)),
                ('status', models.CharField(choices=[('done', 'Done'), ('active', 'Active'), ('deleted', 'Deleted')], default='active', max_length=20)),
                ...
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='task_project', to='tdtaskManagement.project')),
            ],
        ),
